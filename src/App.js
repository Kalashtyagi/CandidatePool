...
import CandidatePool from "./pages/CandidateProfile/candidatePool";
import ShortListed from "./pages/Shortlisted/shortlist";
import Mrf from "./pages/MRF/Mrf";
import AddMrf from "./pages/MRF/AddMrf";
import { AddCandidateFeedback } from "./pages/dashboard/feedbackform/AddCandidateFeedback";
import CandidateOfferLetter from "./pages/dashboard/offerletter/CandidateOfferLetter";
import CandidateOnboard from "./pages/dashboard/onboard/CandidateOnboard";
import CandidateSalary from "./pages/dashboard/salary/CandidateSalary";
import ShowCandidatefeedback from "./pages/dashboard/feedbackform/ShowCandidatefeedback";
import ViewSalary from "./pages/dashboard/salary/ViewSalary";
import MrfApproval from "./pages/Shortlisted/MrfApproval";
import ViewInterview from "./pages/dashboard/interviewschedule/ViewInterview";
import CandidateDocument from "./pages/document/CandidateDocument";
import { ViewCandDocs } from "./pages/document/ViewCandDocs";
import CandidatePCC from "./pages/document/CandidatePCC";
function App() {
  return (
    <div className=" font-roboto text-[14px]">
      <Routes>
        ...
        <Route path={'/candidate/action/:encryptedId/:action'} element={<ShortListed />} />
        <Route path={'/:mrfApprovalLink/:encryptedId'} element={<MrfApproval />} />
        ...
        <Route path="/admin" element={<DashboardLayout />}>
          ...
          <Route
            path="viewinterview/:id"
            element={<ViewInterview />}
          />
           <Route path="candidateDocumentation" element={<CandidateDocument/>}/>
           <Route path = "candidatePCC" element={<CandidatePCC/>}/>
           <Route path="viewDocs/:id" element={<ViewCandDocs/>}/>
          <Route path="addskill" element={<AddSkills />} />
          <Route path="jobcategory" element={<JobCategories />} />
          <Route path="projectTitle" element={<Title />} />
          ...
          <Route path="addMrf" element={<AddMrf />} />
          <Route
          ...
          <Route path="candidatePool" element={<CandidatePool />} />
          ...
          <Route path="addCandidateFeedback/:id" element={<AddCandidateFeedback />} />
          <Route path="Addnewofferletter" element={<AddNewOfferletter />} />
          <Route path="showCandidateFeedback" element={<ShowCandidatefeedback />} />
          ...
          <Route
            path="candidateOfferLetter/SendOfferLetter/:id/:candidateId"
