      ...
      >
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 p-2 ">
          ...
          <div className="col-span-1 px-2 my-1">
            ...
            <Select
              isDisabled
              value={[{ label: data && data[0]?.jobapplication?.location }]}
              className="shadow appearance-none border rounded mt-1 w-full text-black"
            />
          </div>
        ...
        <div className="space-y-2 col-span-2 py-3 px-2">
          ...
          <button
            ...
            disabled={isLoading}
          >
            {isLoading?<i className="fas fa-spinner fa-spin mr-2"></i>:"Approve"}
          </button>
          ...
          >
            {isLoading?<i className="fas fa-spinner fa-spin mr-2"></i>:"Decline"}
          </button>
        </div>
      </form>
    </div>
