...
function Document() {
    ...
    return (
      ...
      <div className="flex justify-center items-center h-screen">
        ...
        <div className='flex  bg-primary p-2 px-4'>
            ...
            <div className='flex pt-5 pl-4'>
             <button type='Submit' disabled={isLoading}className=' bg-primary flex justify-center items-center text-white h-10 w-32 rounded-lg hover:bg-gray-600 hover:text-white  delay-75 duration-75'>{isLoading?<i className="fas fa-spinner fa-spin mr-2"></i>:"Submit"}</button>
