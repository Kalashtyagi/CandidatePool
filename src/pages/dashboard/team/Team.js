    ...
    const getTeamApi = async () => {
      ...
      try{
        ...
        if(request?.status==200){
         ...
         console.log("Josonresponse",jsonResponse);
  ...
  // console.log("Team List",teamList)
    ...
    return (
      <div>
        ...
        {showEditTeamModal ? 
          <>
            <div className="justify-center items-center  flex overflow-y-auto max-h-[calc(100vh-150px)] fixed inset-0 z-50 m-4  outline-none focus:outline-none scrollbar-custom ">
        ...
        <div className="mt-4 px-4 border border-gray-300 rounded-lg bg-white mx-4">
          ...
          <Circles color="#00BFFF" height={80} width={80} />
            ...
            : <div className="overflow-y-auto max-h-[calc(100vh-150px)] border rounded-lg scrollbar-custom ">
