...
console.log(netTakeHomeSalary)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("location", `${state?.CurrentLocation}`);
      ...
      const request = await axios.postForm(
        `${process.env.REACT_APP_API_URL}salarycreate/${state?.Id}`,
        formdata,
        {
          headers: {
  ...
  return (
    ...
    <div className="py-3 bg-gradient-to-r from-blue-100 to-blue-200" >
      ...
      >
              <div className=" py-4  overflow-y-auto max-h-[calc(90vh-130px)] ">
        ...
        <div className="space-y-2 col-span-2 py-3 px-2">
          <button
            ...
            disabled={isLoading}
          >
            {isLoading? <i className="fas fa-spinner fa-spin mr-2"></i>:"submit"}
          </button>
        </div>
        </div>
