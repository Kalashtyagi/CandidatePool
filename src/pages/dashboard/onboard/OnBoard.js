  ...
  const getData = async () => {
    try {
      ...
      if (apiResponse?.code === 200) {
        setOnboardList(apiResponse?.data);
      } else {
        console.log("API Response", apiResponse);
      }
  ...
  return (
    <div>
...

      {
        showMessagePopup ?
          <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none view_onboard scrollbar-custom" Style={{ height: '300px' }}>
