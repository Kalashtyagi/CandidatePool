...
const AddJobDescription = () => {
  ...
  return (
    <>
      ...
      <div className=" overflow-y-auto max-h-[calc(100vh-50px)] border rounded border-t-2 border-r-gray-400 border-l-gray-400 border-b-gray-400 border-gray-800 p-4 mx-4 my-2 bg-white">
      <BackButton route={-1}/>
