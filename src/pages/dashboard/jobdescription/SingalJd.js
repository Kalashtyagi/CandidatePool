...
const SingalJd = () => {
  ...
  return (
    <>
        <div className='overflow-y-auto max-h-[calc(100vh-50px)] scrollbar-custom'>  

      <div className="mt-4 px-4 border 
      border-gray-800 border-t-4 bg-white mx-4">
        <BackButton route = {-1}/>
        
        <div className="flex flex-col">
          <div className="flex my-5 justify-end">
            {hasPermission("edit_jd") && (
