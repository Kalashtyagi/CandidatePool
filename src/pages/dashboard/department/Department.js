...
const Department = () => {
  ...
  const filteredData = department && department?.filter((data)=>data?.DepartmentName?.toLowerCase().includes(search))
          ...
          <>
          {
            ...
            <button
              onClick={() => {
                ...
                setContentEdit(row);
                setEditDepartment(row?.DepartmentName);
              }}
              className=""
            >
              <FaEdit
              ...
              onClick={async() => {
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    await fetch(`${process.env.REACT_APP_API_URL}department/delete/${row?.DepartmentId}`,
                    {
                      method: "POST",
                      headers: {
                        Authorization: `${authorize}`,
                  ...
                  onClick={async() => {
                    try {
                      const request = await fetch(
                         `${process.env.REACT_APP_API_URL}department/update/${contentEdit?.DepartmentId}`,
                         {
                           method: "post",
                           headers: {
                             Authorization: `${authorize}`,
