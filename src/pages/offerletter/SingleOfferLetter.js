...
const SingleOfferLetter = () => {
  ...
  return (
    <>
      <div className="overflow-y-auto overflow-x-hidden max-h-[calc(110vh-150px)] border rounded border-t-2 border-r-gray-400 border-l-gray-400 border-b-gray-400 border-gray-800 p-4 mx-4 my-2 bg-white scrollbar-custom">
      <BackButton route={-1}/>
