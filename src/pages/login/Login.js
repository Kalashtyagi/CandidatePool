  ...
  return (
    <div>
      ...
      <div className={`${error? "h-[360px]":"h-[340px]"}  mt-[5%] shadow-2xl md:w-[25%] w-[80%] bg-white justify-center border rounded rounded-t-lg`} >
        <div className="px-10 py-4 justify-center flex rounded-t-lg bg-[#103f59]">
          <Link to="/">
              ...
              <div className="py-2">
                  ...
                  <div className="">
                    <label className="flex items-center">
                      ...
                      >
                        <input
                          type="checkbox"
                          className="w-4 h-4 text-sky-700 bg-[#103f59] border-gray-500 rounded focus:ring-sky-700 dark:focus:ring-sky-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        />
                      </div>
                ...
                <div className="cols-span-12 mt-4">
                  <input
                    ...
                    className="w-full cursor-pointer border border-slate-700 rounded text-white hover:bg-white hover:text-slate-700 py-2 bg-[#103f59] delay-100 block"
                    disabled={loading}
                  />
                </div>
              </div>
